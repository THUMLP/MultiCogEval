...
def extract_history_general(text):
    """
...
def extract_physical_examination_general(text):
    ...
    while not success and i < len(pe_strings):
        for string in ["pertinent results:", "brief hospital course:","hospital course:","impression:","laboratory data:","CONCISE SUMMARY OF HOSPITAL COURSE:","ADMISSION LABS","Medications on Admission:","LABORATORY EVALUATION:"]:
            string = string.lower()
